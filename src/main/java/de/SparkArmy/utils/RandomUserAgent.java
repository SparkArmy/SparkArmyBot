...
/**
 * This is not from me, this file is copy-pasted form this file here
 * 		GitHub:
 * 			https://github.com/mkstayalive/random-user-agent-java/blob/master/RandomUserAgent.java
 * 		Author:
 * 			https://linkedin.com/in/manishsingh123/
 * */

public enum RandomUserAgent {
    ;
	...
	static {
        ...
        RandomUserAgent.freqMap.put("Internet Explorer", 11.8);
        RandomUserAgent.freqMap.put("Firefox", 28.2);
        RandomUserAgent.freqMap.put("Chrome", 52.9);
        RandomUserAgent.freqMap.put("Safari", 3.9);
        RandomUserAgent.freqMap.put("Opera", 1.8);

        RandomUserAgent.uaMap.put("Internet Explorer", new String[] {
        ...
        RandomUserAgent.uaMap.put("Firefox", new String[] {
        ...
        RandomUserAgent.uaMap.put("Chrome", new String[] {
        ...
        RandomUserAgent.uaMap.put("Safari", new String[] {
        ...
        RandomUserAgent.uaMap.put("Opera", new String[] {
	...
	public static String getRandomUserAgent() {
		...
		String browser = null;
		double count = 0.0;
		for(Map.Entry<String, Double> freq : RandomUserAgent.freqMap.entrySet()) {
			count += freq.getValue();
			if(rand <= count) {
				browser = freq.getKey();
				break;
		...
		String[] userAgents = RandomUserAgent.uaMap.get(browser);
