...
//
//import de.sparkarmy.data.value.ChannelValue;
//import de.sparkarmy.data.database.entity_old.DBPunishment;
...
//
//    public AbstractPunishment(@NotNull SlashCommandInteractionEvent event) {
...
//        return new DBPunishment(this.guild, this.moderator, this.target, type, this.reason, null).createPunishmentEntry();
//    }
//
...
//        String url;
//        DBChannel log = DBChannel.getDBChannel(guild.getIdLong(), ChannelValue.MOD_LOG);
//        if (log == null) {
//            log = DBChannel.getDBChannel(guild.getIdLong(),ChannelValue.SERVER_LOG);
//            if (log == null) {
//                return null;
//            }
//            url = log.getWebhookUrl();
