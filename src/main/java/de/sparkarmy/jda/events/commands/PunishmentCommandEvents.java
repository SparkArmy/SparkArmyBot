...
//
//        guild.retrieveBanList() // TODO Check if resolve this with flatMap
////                .flatMap(bans->bans.stream().noneMatch(x->x.getUser().equals(target)),
////                        x->
////                        hook.editOriginal(bundle.getString("command.userIsNotInBanList")))
//                .queue(banList -> {
...
//                        long value = new DBPunishment(guild, moderator.getUser(), target, PunishmentType.UNBAN, reason, null).createPunishmentEntry();
//                        if (value < 0) {
