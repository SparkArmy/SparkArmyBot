...
//                    }
//
//                    List<Role> muteRoleList = getMuteRole();
//                    if (muteRoleList == null) {
...
//                    }
//
//                    return guild.modifyMemberRoles((Member) memberAsObject,muteRoleList)
//                            .reason(this.reason)
...
//    }
//
//    private @Nullable List<Role> getMuteRole() {
//        List<Role> roleList = this.guild.getRoles().stream()
//                .filter(x -> RoleValueUtil.checkIsApplied(DBRole.getDBRoleByRole(x).getRoleValuesRaw(), RoleValue.MUTE_ROLE))
//                .toList();
